    ...
    <div className="bg-gray-100 px-[200px] h-[60vh] mt-[50px]">
      <div className="flex justify-between py-[5%]">
        <div>
          ...
          <p className="mt-2">Every donation is a chance to save a life.</p>
        </div>
        ...
        <div className="w-full md:w-1/3">
          ...
          <p className="mt-2">123 Chaurasia Street, New Delhi, India</p>
          <p className="mt-2">Phone: +91 98765 43210 </p>
          <p className="mt-2">Email: info.donorlink@gmail.com</p>
        </div>
      </div>
